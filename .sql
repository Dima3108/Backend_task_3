--------------------------------------------------------
--  File created - вторник-апреля-04-2023   
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into C##HR.AUTO_SAL (ID_S,CITY,STREET) values ('10001','Краснодар','ул. Северная');
Insert into C##HR.AUTO_SAL (ID_S,CITY,STREET) values ('10002','Краснодар','ул. Школьная');
Insert into C##HR.AUTO_SAL (ID_S,CITY,STREET) values ('10003','Краснодар','ул. Красная');
Insert into C##HR.AUTO_SAL (ID_S,CITY,STREET) values ('10004','Краснодар','ул. Уральская');
...
SET DEFINE OFF;
Insert into C##HR.DOLJ (KOD_DOLJ,DOLJ) values ('1','Тимлид');
Insert into C##HR.DOLJ (KOD_DOLJ,DOLJ) values ('2','Техдир');
...
SET DEFINE OFF;
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('1','Иванов','Иван','Иванович','ПВС Западного округа','3310 124568');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('2','Петров','Петр','Петрович','ПВС Центрального округа','3250 145868');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('3','Сидоров','Иван','Иванович','ПВС Западного округа','7810 124879');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('4','Иванов','Иван','Иванович',null,null);
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('5','Сидоров','Петр','Иванович','ПВС Западного округа','3310 124568');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('6','Иван','Иванович','Иванов','ПВС Западного округа','3310 124568');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('7','Петр','Петрович','Петров','ПВС Центрального округа','3250 145868');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('8','Иван','Иванович','Сидоров','ПВС Западного округа','7810 124879');
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('9','Иван','Иванович','Иванов',null,null);
Insert into C##HR.S_FIZ_LIC (KOD,FAM,IM,OTCH,P_VIDAN,P_SER_NOM) values ('10','Иван','Иванович','Иванов','ПВС Западного округа','3310 124568');
REM INSERTING into C##HR.S_FIZ_LIC3
SET DEFINE OFF;
Insert into C##HR.S_FIZ_LIC3 (KOD,FIO) values ('5','ИВАНОВ ИВАН ИВАНОВИЧ');
