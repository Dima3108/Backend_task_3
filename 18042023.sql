--------------------------------------------------------
--  File created - вторник-апреля-18-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##HR"."AUTO" 
   (	"ID_AUTO" NUMBER(25,0), 
	"ID_DEALERSHIP" NUMBER(25,0), 
	"MARK" VARCHAR2(25 BYTE), 
	"COUNTRY_OF_ASSEMBLY" VARCHAR2(25 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table AUTO_DEALERSHIP
--------------------------------------------------------

  CREATE TABLE "C##HR"."AUTO_DEALERSHIP" 
   (	"ID_DEALERSHIP" NUMBER(25,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table AUTO_FOR_RENT
--------------------------------------------------------

  CREATE TABLE "C##HR"."AUTO_FOR_RENT" 
   (	"ID_AUTO_IN_RENT" NUMBER(25,0), 
	"ID_TENANT" NUMBER(25,0), 
	"ID_AUTO" NUMBER(25,0), 
	"ID_DEALERSHIP" NUMBER(25,0), 
	"DATE_OF_CAPTURE" DATE, 
	"RETURN_TO" DATE, 
	"RETURNED" VARCHAR2(25 BYTE), 
	"FINE" VARCHAR2(25 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
WITH READ ONLY
;
REM INSERTING into C##HR.AUTO
SET DEFINE OFF;
Insert into C##HR.AUTO (ID_AUTO,ID_DEALERSHIP,MARK,COUNTRY_OF_ASSEMBLY,COLOR) values ('1','10000','Хундай','Чина','Жёлтый');
Insert into C##HR.AUTO (ID_AUTO,ID_DEALERSHIP,MARK,COUNTRY_OF_ASSEMBLY,COLOR) values ('2','10001','БНВ','Джёрмани','Блэк');
Insert into C##HR.AUTO (ID_AUTO,ID_DEALERSHIP,MARK,COUNTRY_OF_ASSEMBLY,COLOR) values ('3','10002','Audi','USA','White');
Insert into C##HR.AUTO (ID_AUTO,ID_DEALERSHIP,MARK,COUNTRY_OF_ASSEMBLY,COLOR) values ('4','10003','Ford','USA','Gray');
Insert into C##HR.AUTO (ID_AUTO,ID_DEALERSHIP,MARK,COUNTRY_OF_ASSEMBLY,COLOR) values ('5','10004','ЛадаГранта','Россия','Красивый');
REM INSERTING into C##HR.AUTO_DEALERSHIP
SET DEFINE OFF;
Insert into C##HR.AUTO_DEALERSHIP (ID_DEALERSHIP,CITY,STREET) values ('10000','Краснодар','Ставропольс');
Insert into C##HR.AUTO_DEALERSHIP (ID_DEALERSHIP,CITY,STREET) values ('10001','Краснодар','Школьная');
Insert into C##HR.AUTO_DEALERSHIP (ID_DEALERSHIP,CITY,STREET) values ('10002','Краснодар','Северная');
Insert into C##HR.AUTO_DEALERSHIP (ID_DEALERSHIP,CITY,STREET) values ('10003','Краснодар','Солнечная');
Insert into C##HR.AUTO_DEALERSHIP (ID_DEALERSHIP,CITY,STREET) values ('10004','Краснодар','Шевченко');
REM INSERTING into C##HR.AUTO_FOR_RENT
SET DEFINE OFF;
Insert into C##HR.AUTO_FOR_RENT (ID_AUTO_IN_RENT,ID_TENANT,ID_AUTO,ID_DEALERSHIP,DATE_OF_CAPTURE,RETURN_TO,RETURNED,FINE) values ('2','2','2','10001',to_date('02.01.01','DD.MM.RR'),to_date('29.01.01','DD.MM.RR'),'Не вернули','$50000');
Insert into C##HR.AUTO_FOR_RENT (ID_AUTO_IN_RENT,ID_TENANT,ID_AUTO,ID_DEALERSHIP,DATE_OF_CAPTURE,RETURN_TO,RETURNED,FINE) values ('3','3','3','10002',to_date('02.01.02','DD.MM.RR'),to_date('29.01.02','DD.MM.RR'),'Пропали','$500000');
Insert into C##HR.AUTO_FOR_RENT (ID_AUTO_IN_RENT,ID_TENANT,ID_AUTO,ID_DEALERSHIP,DATE_OF_CAPTURE,RETURN_TO,RETURNED,FINE) values ('4','4','4','10003',to_date('02.01.03','DD.MM.RR'),to_date('29.01.03','DD.MM.RR'),'Вернули','$0');
Insert into C##HR.AUTO_FOR_RENT (ID_AUTO_IN_RENT,ID_TENANT,ID_AUTO,ID_DEALERSHIP,DATE_OF_CAPTURE,RETURN_TO,RETURNED,FINE) values ('5','5','5','10004',to_date('02.01.04','DD.MM.RR'),to_date('29.01.04','DD.MM.RR'),'Вернули','$100, а чё)');
...
REM INSERTING into C##HR.TENANT
SET DEFINE OFF;
Insert into C##HR.TENANT (ID_TENANT,NAME,LAST_NAME,DATE_OF_BIRTH,ADRESS,TELEPHONE) values ('1','Фёдор','Сумкин',to_date('11.11.03','DD.MM.RR'),'Краснодар','+79181111111');
Insert into C##HR.TENANT (ID_TENANT,NAME,LAST_NAME,DATE_OF_BIRTH,ADRESS,TELEPHONE) values ('2','Сеня','Лютый',to_date('12.12.03','DD.MM.RR'),'Шир','+79181111112');
Insert into C##HR.TENANT (ID_TENANT,NAME,LAST_NAME,DATE_OF_BIRTH,ADRESS,TELEPHONE) values ('3','Жора','Игнатов',to_date('10.10.03','DD.MM.RR'),'Краснодар','+79181111113');
Insert into C##HR.TENANT (ID_TENANT,NAME,LAST_NAME,DATE_OF_BIRTH,ADRESS,TELEPHONE) values ('4','Дед','Дамблдор',to_date('09.09.03','DD.MM.RR'),'Хогвартс','+79181111114');
Insert into C##HR.TENANT (ID_TENANT,NAME,LAST_NAME,DATE_OF_BIRTH,ADRESS,TELEPHONE) values ('5','Сергей','Датабазный',to_date('08.08.03','DD.MM.RR'),'MariaDB','+79181111115');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008799" ON "C##HR"."AUTO_DEALERSHIP" ("ID_DEALERSHIP") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008802" ON "C##HR"."TENANT" ("ID_TENANT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008806" ON "C##HR"."AUTO" ("ID_AUTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008810" ON "C##HR"."AUTO_FOR_RENT" ("ID_AUTO_IN_RENT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."AUTO" MODIFY ("MARK" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."AUTO" MODIFY ("COLOR" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."AUTO" ADD PRIMARY KEY ("ID_AUTO")
...
--------------------------------------------------------
--  Constraints for Table AUTO_DEALERSHIP
--------------------------------------------------------

  ALTER TABLE "C##HR"."AUTO_DEALERSHIP" MODIFY ("CITY" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."AUTO_DEALERSHIP" MODIFY ("STREET" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."AUTO_DEALERSHIP" ADD CHECK (id_dealership >= 10000 AND id_dealership <= 99999) ENABLE;
  ALTER TABLE "C##HR"."AUTO_DEALERSHIP" ADD CHECK (SUBSTR(city, 1) BETWEEN 'А' AND 'Я') ENABLE;
  ALTER TABLE "C##HR"."AUTO_DEALERSHIP" ADD PRIMARY KEY ("ID_DEALERSHIP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Constraints for Table AUTO_FOR_RENT
--------------------------------------------------------

  ALTER TABLE "C##HR"."AUTO_FOR_RENT" MODIFY ("DATE_OF_CAPTURE" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."AUTO_FOR_RENT" MODIFY ("RETURN_TO" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."AUTO_FOR_RENT" ADD PRIMARY KEY ("ID_AUTO_IN_RENT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."TENANT" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."TENANT" MODIFY ("LAST_NAME" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."TENANT" ADD PRIMARY KEY ("ID_TENANT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##HR"."TENANT" ADD CONSTRAINT "TELE" CHECK (ASCII(SUBSTR(telephone, 1)) = ASCII('+')) ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AUTO
--------------------------------------------------------

  ALTER TABLE "C##HR"."AUTO" ADD FOREIGN KEY ("ID_DEALERSHIP")
	  REFERENCES "C##HR"."AUTO_DEALERSHIP" ("ID_DEALERSHIP") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AUTO_FOR_RENT
--------------------------------------------------------

  ALTER TABLE "C##HR"."AUTO_FOR_RENT" ADD FOREIGN KEY ("ID_TENANT")
	  REFERENCES "C##HR"."TENANT" ("ID_TENANT") ENABLE;
  ALTER TABLE "C##HR"."AUTO_FOR_RENT" ADD FOREIGN KEY ("ID_AUTO")
	  REFERENCES "C##HR"."AUTO" ("ID_AUTO") ENABLE;
  ALTER TABLE "C##HR"."AUTO_FOR_RENT" ADD FOREIGN KEY ("ID_DEALERSHIP")
	  REFERENCES "C##HR"."AUTO_DEALERSHIP" ("ID_DEALERSHIP") ENABLE;
--------------------------------------------------------
