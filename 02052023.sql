--------------------------------------------------------
--  File created - вторник-мая-02-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##HR"."Group" 
   (	"ID_GROUP" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"GROUP_NO" VARCHAR2(255 BYTE), 
	"YEAR" NUMBER, 
	"COURSE" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table GROUP1
--------------------------------------------------------

  CREATE TABLE "C##HR"."GROUP1" 
   (	"ID_GROUP" NUMBER, 
	"GROUP_NO" VARCHAR2(10 BYTE), 
	"YEAR" VARCHAR2(8 BYTE), 
	"COURSE" NUMBER, 
	"SEMESTER" VARCHAR2(5 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##HR"."SCHEDULE" 
   (	"ID_GROUP" NUMBER, 
	"ID_SUB" NUMBER, 
	"CLASS_NO" NUMBER, 
	"CLASSROOM_NO" VARCHAR2(5 BYTE), 
	"WEEKDAY" VARCHAR2(5 BYTE)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table STRUCTURE_GROUP
--------------------------------------------------------

  CREATE TABLE "C##HR"."STRUCTURE_GROUP" 
   (	"ID_STUDENT" NUMBER, 
	"ID_GROUP" NUMBER
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##HR"."STUDENT" 
   (	"ID_STUDENT" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##HR"."SUBJECT" 
   (	"ID_SUB" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
WITH READ ONLY
;
REM INSERTING into C##HR.ARTICLE
SET DEFINE OFF;
...
Insert into C##HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('120','Matthew','Weiss','MWEISS','650.123.1234',to_date('18.07.96','DD.MM.RR'),'ST_MAN','8000',null,'100','50');
...
Insert into C##HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('122','Payam','Kaufling','PKAUFLIN','650.123.3234',to_date('01.05.95','DD.MM.RR'),'ST_MAN','7900',null,'100','50');
...
REM INSERTING into C##HR."Group"
SET DEFINE OFF;
REM INSERTING into C##HR.GROUP1
SET DEFINE OFF;
...
REM INSERTING into C##HR.SCHEDULE
SET DEFINE OFF;
REM INSERTING into C##HR.STRUCTURE_GROUP
SET DEFINE OFF;
REM INSERTING into C##HR.STUDENT
SET DEFINE OFF;
Insert into C##HR.STUDENT (ID_STUDENT,FULLNAME,GRADEBOOK_NO,DATE_IN,PHONE) values ('1','Иванов Иван Иванович','1001',to_date('01.09.19','DD.MM.RR'),'+79123456789');
Insert into C##HR.STUDENT (ID_STUDENT,FULLNAME,GRADEBOOK_NO,DATE_IN,PHONE) values ('2','Петров Петр Петрович','1002',to_date('01.09.19','DD.MM.RR'),'+79123456790');
Insert into C##HR.STUDENT (ID_STUDENT,FULLNAME,GRADEBOOK_NO,DATE_IN,PHONE) values ('3','Сидоров Сидор Сидорович','1003',to_date('01.09.20','DD.MM.RR'),'+79123456791');
REM INSERTING into C##HR.SUBJECT
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008897" ON "C##HR"."ARTICLE" ("ID_ART") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C008942
--------------------------------------------------------

  CREATE UNIQUE INDEX "C##HR"."SYS_C008942" ON "C##HR"."STUDENT" ("ID_STUDENT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008946" ON "C##HR"."SUBJECT" ("ID_SUB") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008965" ON "C##HR"."Group" ("ID_GROUP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##HR"."SYS_C008968" ON "C##HR"."GROUP1" ("ID_GROUP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C008897
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."ARTICLE" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."ARTICLE" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."ARTICLE" ADD CHECK (length(type) = 2 and ((type) = 'кг' or (type) = 'шт')) ENABLE;
  ALTER TABLE "C##HR"."ARTICLE" ADD PRIMARY KEY ("ID_ART")
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."Group" MODIFY ("ID_GROUP" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."Group" MODIFY ("GROUP_NO" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."Group" MODIFY ("YEAR" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."Group" ADD CHECK (course BETWEEN 1 AND 10) ENABLE;
  ALTER TABLE "C##HR"."Group" ADD PRIMARY KEY ("ID_GROUP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."GROUP1" MODIFY ("GROUP_NO" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."GROUP1" MODIFY ("COURSE" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."GROUP1" ADD PRIMARY KEY ("ID_GROUP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."SCHEDULE" MODIFY ("ID_GROUP" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."SCHEDULE" MODIFY ("ID_SUB" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STRUCTURE_GROUP
--------------------------------------------------------

  ALTER TABLE "C##HR"."STRUCTURE_GROUP" MODIFY ("ID_STUDENT" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."STRUCTURE_GROUP" MODIFY ("ID_GROUP" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STUDENT
--------------------------------------------------------

  ALTER TABLE "C##HR"."STUDENT" MODIFY ("ID_STUDENT" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."STUDENT" MODIFY ("FULLNAME" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."STUDENT" MODIFY ("GRADEBOOK_NO" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."STUDENT" MODIFY ("DATE_IN" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."STUDENT" ADD PRIMARY KEY ("ID_STUDENT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."SUBJECT" MODIFY ("ID_SUB" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."SUBJECT" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "C##HR"."SUBJECT" ADD CHECK (type IN ('лк', 'лб')) ENABLE;
  ALTER TABLE "C##HR"."SUBJECT" ADD PRIMARY KEY ("ID_SUB")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##HR"."SCHEDULE" ADD FOREIGN KEY ("ID_GROUP")
	  REFERENCES "C##HR"."GROUP1" ("ID_GROUP") ENABLE;
  ALTER TABLE "C##HR"."SCHEDULE" ADD FOREIGN KEY ("ID_SUB")
	  REFERENCES "C##HR"."SUBJECT" ("ID_SUB") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table STRUCTURE_GROUP
--------------------------------------------------------

  ALTER TABLE "C##HR"."STRUCTURE_GROUP" ADD FOREIGN KEY ("ID_STUDENT")
	  REFERENCES "C##HR"."STUDENT" ("ID_STUDENT") ENABLE;
  ALTER TABLE "C##HR"."STRUCTURE_GROUP" ADD FOREIGN KEY ("ID_GROUP")
	  REFERENCES "C##HR"."GROUP1" ("ID_GROUP") ENABLE;
