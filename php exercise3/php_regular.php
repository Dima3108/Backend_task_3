<?php
/*
тестирование некоторых регулярных вырожений , не участвет в LibraryPchMain и ReadMessage но небходим , 
чтобы убедится в правильном использование регулярного вырожения
*/ 
$reg="[^0-6]";
